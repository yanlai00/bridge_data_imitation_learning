...
from semiparametrictransfer_experiments.modeltraining.widowx.real.toy_kitchen_v0.dataset_lmdb import TOTAL_NUM_TASKS, bridge_data_config, validation_conf_toykitchen2_room8052
...
data_config = AttrDict(
    main=AttrDict(
        ...
        **validation_conf_toykitchen2_room8052
    )
)
