...
close_box = AttrDict(
    ...
    filtering_function=[lambda dframe: dframe[(dframe['policy_desc'] == 'human_demo, close small 4-flap box flaps') | 
                                                (dframe['policy_desc'] == 'human_demo, close white 1-flap box flap') | 
                                                (dframe['policy_desc'] == 'human_demo, close brown 1-flap box flap') ]],
    aliasing_dict=task_name_aliasing_dict,
)

validation_close_box = AttrDict(
    val0=AttrDict(
...
source_data = close_box
validation_data = validation_close_box
