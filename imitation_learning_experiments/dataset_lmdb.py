...
toykitchen1 = AttrDict(
            ...
            color_augmentation=0.1,
            image_size_beforecrop=[112, 144],
            data_dir=os.environ['DATA'] + '/robonetv2/toykitchen_delay1/toykitchen1',
            aliasing_dict=task_name_aliasing_dict,
            excluded_dirs=excluded_dirs,
)
...
dagger_toykitchen1 = AttrDict(
            name='dagger_toykitchen1',
            random_crop=[96, 128],
            color_augmentation=0.1,
            image_size_beforecrop=[112, 144],
            data_dir=os.environ['DATA'] + '/robonetv2/toykitchen_delay1/dagger_toykitchen1',
            excluded_dirs=excluded_dirs,
            aliasing_dict=task_name_aliasing_dict,
        )
