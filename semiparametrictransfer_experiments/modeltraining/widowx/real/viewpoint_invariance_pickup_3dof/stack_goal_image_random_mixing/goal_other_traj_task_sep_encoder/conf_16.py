...
for train_key in train_keys:
    ...
    data_config.main.dataconf[train_key][1].final_image_match = 'task'
    data_config.main.dataconf[train_key][1].stack_goal_images = 8

val_keys = [k for k in data_config.main.keys() if k.startswith('val')]
for val_key in val_keys:
    data_config.main[val_key].dataconf.get_final_image_from_same_traj = False
    data_config.main[val_key].dataconf.final_image_match = 'task'
    data_config.main[val_key].dataconf.stack_goal_images = 8
