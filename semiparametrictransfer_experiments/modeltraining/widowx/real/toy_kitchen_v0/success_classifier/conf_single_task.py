...
sweet_potato_in_pot_cam0_positive = AttrDict(
            name='sweet_potato_in_pot_cam0_pos',
            random_crop=[96, 128],
            ...
            filtering_function=[lambda dframe: dframe[(dframe['environment'] == 'toykitchen2_room8052')
                                & (dframe['camera_index'] == 0)
                                & (dframe['policy_desc'] == 'human_demo, put sweet potato in pot')
                                & (dframe['tstep_reverse'] < 2)]],
            aliasing_dict=task_name_aliasing_dict,
        )

sweet_potato_in_pot_cam0_negative = AttrDict(
            name='sweet_potato_in_pot_cam0_neg',
            random_crop=[96, 128],
            color_augmentation=0.1,
            image_size_beforecrop=[112, 144],
            data_dir=os.environ['DATA'] + '/robonetv2/toykitchen_fixed_cam/',
    ...
    main=AttrDict(
        ...
        dataconf=AttrDict(
            dataset0=[
                ...
                sweet_potato_in_pot_cam0_positive,
                0.5,
            ],
            dataset1=[
                LMDB_Dataset_Success_Classifier,
                sweet_potato_in_pot_cam0_negative,
                0.5,
            ],
        ),
    )
